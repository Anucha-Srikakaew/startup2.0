    ...
    <section id="main">
            ...
            <div ng-switch="myVar">
                ...
                <div ng-switch-when="LINE">
                    <select name="txtLINE" id="txtLINE">
                        <?php
                            if($TYPE=='ADMIN')
                            {
                                $BIZ = $_POST['BIZ'];
                ...
                <div ng-switch-when="PROCESS">
                    <input id="txtPROCESS"  name="txtPROCESS"  type="text" class="text" placeholder="PROCESS"  oninput="this.value = this.value.toUpperCase()">
                ...
                <div ng-switch-when="PERIOD">
                    <select id="txtPERIOD" name="txtPERIOD">
...
<input type="button" value="RESET" onClick="window.location.reload()">
                        ...
                        <table class="table">
                            ...
                            <!-- QUERY BIZ -->
                                ...
                                ?>
                        <form method="POST" action="item_save.php?Action=Copy">
                            <tbody>
                                <tr>
                                            ...
                                            <select name="LINE[]" id="LINE">
                                                    <?php
                                                        if($TYPE=='ADMIN')
                                                        {
                                                            ...
                                                            echo "<option disabled value='$LINE'>$LINE</option>";
                                        ...
                                        <!-- SELECT LINE TYPE -->
                                            <select name="TYPE[]" id="TYPE">
                                                    <?php
                                                        if($TYPE=='ADMIN')
                                                        {
                                                            echo "<option disabled value='$TYPE'>$TYPE</option>";
                                    ...
                                    <td>
                                        <!-- INPUT PROCESS -->
                                        <input name="PROCESS[]" type="text" value="<?php echo $PROCESS;?>">
                                    </td>

                                    <td>
                                        <input name="ITEM[]"  class="col-lg-12" type="text" value="<?php echo $ITEM;?>">
                                    </td>
                                        ...
                                        <!-- SELECT LINE TYPE -->
                                            <select name="SPEC[]" id="SPEC">
                                                    <?php
                                                        ...
                                                        {
                                                            echo "<option disabled value='$SPEC'>$SPEC</option>";
                                    ...
                                    <td>
                                        <select name="PIC[]" id="PIC" >
                                            <option disabled  value='<?php echo $PIC;?>'><?php echo $PIC;?></option>
                                            <option value="MFE">MFE</option>
                                            <option value="PROD">PROD</option>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <select name="PERIOD[]" id="PERIOD" >
                                            <option disabled value='<?php echo $PERIOD;?>'><?php echo $PERIOD;?></option>
                                            <option value="SHIFT">SHIFT</option>
                                            <option value="DAY">DAY</option>
                                            <option value="WEEK">WEEK</option>
                                            <option value="MONTH">MONTH</option>
