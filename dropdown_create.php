<html>  
                            ...
                            <form name="add_name" id="add_name">  
                                <div class="table-responsive text-center">  
                                    <table class="table table-hover table-striped table-bordered thead-light" id="dynamic_field">  
                                            <tr>
                                                <th>
                                                    <input id="DROPDOWN_NAME"  name="DROPDOWN_NAME"  type="text" class="form-control name_list" placeholder="DROPDOWN NAME" oninput="this.value = this.value.toUpperCase()" style="font-weight: bold;">
                                                    <input id="BIZ" name="BIZ" type="hidden" value="<?php echo $_GET['BIZ'];?>">
                                                </th>
                                            </tr>
                                            <tr>  
                                                <td><input type="text" name="name[]" placeholder="DROPDOWN CASE 1 " class="form-control name_list" oninput="this.value = this.value.toUpperCase()"/></td>  
                                            </tr>  
                                    </table>  
 ...
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="name[]" placeholder="DROPDOWN CASE '+i+'" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove"><i class="fa fa-minus"></i></button></td></tr>');  
      });  
