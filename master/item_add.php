...
<head>
    ...
    <script>
        ...
        function fncSubmit() {
            ...
            if (document.form.SPEC_DES.value == "") {
                alert('Please fill SPEC_DES information.');
                document.form.SPEC_DES.focus();
                return false;
            }
            ...
            if (document.form.PERIOD.value == "") {
                alert('Please select PERIOD for this item.');
    ...
    <section id="main">
        ...
        <div class="container">
            <div class="col-lg-8 mx-auto">
                <form name="form" method="POST" action="item_save.php?Action=Add" onSubmit="JavaScript:return fncSubmit();">
                    ...
                    <!-- INPUT PROCESS  -->
                    <input id="PROCESS" name="PROCESS" type="text" class="text" placeholder="PROCESS">
                    ...
                    <!-- INPUT PROCESS  -->
                    <input id="SPEC_DES" name="SPEC_DES" type="text" class="text" placeholder="SPEC_DES" oninput="this.value = this.value.toUpperCase()">

                    <script type="text/javascript">
                        document.getElementById('SPEC_DES').value = "<?php echo $_POST['SPEC_DES']; ?>";
                    </script>
                    ...
                    <div ng-switch="SPEC">
                        <div ng-switch-when="VALUE">
                            <input id="MIN" name="MIN" type="NUMBER" step="any" class="text" placeholder="MIN">
                            <input id="MAX" name="MAX" type="NUMBER" step="any" class="text" placeholder="MAX">
                        ...
                        <div ng-switch-when="DROPDOWN">
                            ...
                            <a target="_blank" rel="noopener noreferrer" style="float: right;" class="text-right text-dark" href="http://43.72.52.52/startup2.0/AC/dropdown_create.php?BIZ=<?php echo $BIZ; ?>">
                                <i class="fa fa-plus"></i> CREATE NEW DROPDOWN
                            </a>
                            <script type="text/javascript">
                    ...
                    <script type="text/javascript">
                        document.getElementById('PERIOD').value = "<?php echo $_POST['PERIOD']; ?>";
                    </script>
